...
def plot_data_plotly(cvals: list[dict]):
       for idx, cvals_tup in enumerate(cvals):
        ...
        fig.add_trace(go.Surface(x=x, y=y, z=z1, colorscale=[[0, 'red'], [1, 'red']], opacity=0.5, showscale=False))
        fig.add_trace(go.Surface(x=x, y=y, z=z2, colorscale=[[0, 'red'], [1, 'red']], opacity=0.5, showscale=False))
        fig.add_trace(go.Surface(x=x, y=y, z=z3, colorscale=[[0, 'red'], [1, 'red']], opacity=0.5, showscale=False))

...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help=(f"Comma-separated list of algorithm names to include.\n"
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help=(f"Comma-separated list of quantum algorithm names to include.\n"
    ...
    include_names = [
        name.strip() for name in args.include_algos.split(",") if name.strip()
    ]
    ...
    for alg in include_names:
        ...
        try:
            ...
            if res.stderr:
                print(
                    "Command succeeded, but there were warnings/errors in stderr:"
                )
                print(res.stderr)
